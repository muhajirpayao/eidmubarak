...
function FireworksCanvas({ triggerCount }: { triggerCount: number }) {
  ...
  useEffect(() => {
    ...
    // spawn 3-5 bursts at random positions
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", width: "80%", opacity: showSub ? 1 : 0, transition: "opacity 0.8s" }}>
          ...
          <div style={{ display: "flex", gap: "0.4rem" }}>
            {["✦", "◆", "✦"].map((s, i) => (
              <span key={i} style={{ color: "#e8b84b", fontSize: "0.6rem", opacity: 0.7 }}>{s}</span>
            ))}
          </div>
          ...
          >
            ...
            <span
              style={{
                ...
                marginRight: "0.5rem",
                animation: "btnStarSpin 3s linear infinite",
                fontSize: "0.9em",
              }}
            >
              ✦
            ...
            <span
              style={{
                display: "inline-block",
                marginLeft: "0.5rem",
                animation: "btnStarSpin 3s linear infinite reverse",
                fontSize: "0.9em",
              }}
            >
              ✦
